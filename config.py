...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", -1001742458891))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_MSG = os.environ.get("START_MESSAGE", "Hey, {first}\n\nI am a Bot to Provide Modded App's File of @Techiefied Channel directly to you :)\n\nYou Must join @Techiefied to use me")
try:
    ADMINS=[]
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Well, as I told you before you have to join @Techiefied Channel to use me !")
